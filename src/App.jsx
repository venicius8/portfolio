  ...
  return (
    <>
      ...
      <section className={Styles.main}>
        ...
        <h2>
          Sou desenvolvedor <br className={Styles.forSmall} />
      ...
      <section id="about" className={Styles.about}>
        ...
        <div className={Styles.justifyAboutMe}>
          <div className={Styles.aboutMe}>
            <p>
              Desde que comecei minha jornada como desenvolvedor full-stack,
              venho me dedicando a transformar <u>ideias em projetos reais</u>.
              Em alguns meses, já criei portfólios, fóruns e aplicações web do
              zero, <u>unindo lógica, código e propósito</u>.
            </p>
        ...
        <p>
          Quero me tornar um desenvolvedor cada vez mais completo, tanto no
          front-end quanto no back-end, sempre buscando clareza, performance e
          boas práticas no que construo. Acredito que{" "}
          <u>
            com consistência e curiosidade, é possível evoluir constantemente
          </u>
          , e estou comprometido com esse caminho.
        </p>
      </section>
      ...
      <footer className={Styles.footer}>
        ...
        <p>
          Feito com <span style={{ color: "red" }}>♥</span> usando React
        </p>
      </footer>
    </>
  );
